...
function FuncBlock(props: FuncProps) {
  const [ blkId, funcId, funcName, funcOptions, paramTypes, paramNames, outputTypes, outputNames, blockLoc, editCB, removeCB, setArrows, addArrow, updateLoc, removeArrow] = [
    props.blockId, 
    props.funcId, 
    props.funcType,
    props.funcName, 
